...
export const SearchInputList: React.FC<IProps> = ({
  input,
  width,
  placeholder,
  toolTipContents,
  ...
  return (
    <>
      ...
      <ListItem
        disabled={disabled}
        listDB={listItemDB}
        listBuss={listItemBuss}
        listInfra={listItemInfra}
        listOS={listItemOS}
        listProg={listItemProg}
...
export const ListItem = ({ disabled, listDB, listOS, listProg, listInfra, listBuss, input, disableDelete }) => {
  const [listItem, setListItem] = useState([
    {
      value: '',
      text: '',
              ...
              <List as="ol" celled>
                <List.Item as="li" value="1">
                  ...
                  <List.Item as="ol">
                    {listBuss != null &&
                      listBuss.map((item) => (
                        <List.Item key={item.text}  as="li" value="*">
                          {item.text}
                        </List.Item>
                      ))}
                  </List.Item>
