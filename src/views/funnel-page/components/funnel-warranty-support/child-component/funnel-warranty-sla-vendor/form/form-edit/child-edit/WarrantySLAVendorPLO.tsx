...
import { Button, NumberInput, DateInput } from 'views/components/UI';
...
const WarrantySLAVendorPLO: React.FC<IProps> = () => {
  ...
  const onSubmitHandler = (values: FunnelWarrantySLAModel) => {
    if (!disableComponent) {
      ...
      values.vendorWarranty = values.pVendor + '/' + values.lVendor + '/' + values.oVendor;
      dispatch(FunnelWarrantyActions.putSLAVendor(values));
    }
  };
        ...
        <Form onSubmit={handleSubmit}>
          <Grid padded>
            ...
            <Grid.Row columns="equal">
              <Grid.Column>
                <Field name="pVendor" component={NumberInput} placeholder="P" labelName="P" disabled={disableComponent} onChange={onChangeP} />
              </Grid.Column>
              <Grid.Column>
                <Field name="lVendor" component={NumberInput} placeholder="L" labelName="L" disabled={disableComponent} onChange={onChangeL} />
              </Grid.Column>
              <Grid.Column>
                <Field name="oVendor" component={NumberInput} placeholder="O" labelName="O" disabled={disableComponent} onChange={onChangeO} />
              </Grid.Column>
            </Grid.Row>
            <Grid.Row>
              <p>
...
export default WarrantySLAVendorPLO;
