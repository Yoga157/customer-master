...
import styles from './SearchMainCBVService.module.scss';
...
export const SearchMainCBVService: React.FC<IProps> = (props: React.PropsWithChildren<IProps>) => {
...
export default SearchMainCBVService;
