...
import styles from './SearchCreditBillingService.module.scss';
...
export const SearchCreditBillingService: React.FC<IProps> = (props: React.PropsWithChildren<IProps>) => {
...
export default SearchCreditBillingService;
