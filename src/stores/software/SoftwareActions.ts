import * as SoftwareEffects from './SoftwareEffects';
...
export const REQUEST_SOFTWARES: string = 'SoftwareActions.REQUEST_SOFTWARES';
export const REQUEST_SOFTWARES_FINISHED: string = 'SoftwareActions.REQUEST_SOFTWARES_FINISHED';

export const requestSoftwares = (activePage: number, pageSize: number): any => {
  return async (dispatch: ReduxDispatch<ActionUnion>, getState: () => IStore): Promise<void> => {
    await ActionUtility.createThunkEffect<SoftwareEnvelope>(dispatch, REQUEST_SOFTWARES, SoftwareEffects.requestSoftwares, activePage, pageSize);
  };
};
