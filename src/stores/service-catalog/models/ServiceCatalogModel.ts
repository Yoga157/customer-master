...
export default class ServiceCatalogModel extends BaseModel {
  svcCatGenID: number = 0;
  svcCatReffID: string = '';
  svcCatID: number = 0;
  employeeID: string = '';
  employeeIDLead:  string = "";
  ...
  constructor(data: Partial<ServiceCatalogModel>) {
    super();
    this.update(data);
  }

  public update(data: Partial<ServiceCatalogModel>): void {
    const conversionOptions: IConversionOption = {
      ...
      employeeIDLead: ConversionTypeEnum.String,
