...
export default class GetActivityReportModel extends BaseModel {
  SO : number = 0;
  CustomerName : string = '';
  ProjectName : string = '';
  ActivityWithInProgressStatus : number = 0;
  ActivityWithPendingStatus : number = 0;
  ActivityWithCloseStatus : number = 0;
  TotalActivities : number = 0;

  constructor(data: Partial<GetActivityReportModel>) {
    super();
    this.update(data);
  }
