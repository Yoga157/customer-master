...
export default class CBVTypeVoucherModel extends BaseModel {
  udcid:number = 0;
  entryKey: string = '';
  text1: string = '';
  text2: string = '';
  ...
  constructor(data: Partial<CBVTypeVoucherModel>) {
    super();
    this.update(data);
  }

  public update(data: Partial<CBVTypeVoucherModel>): void {
