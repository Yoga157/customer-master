...
export default class MasterInsuranceUdcModel extends BaseModel {
  udcid:number = 0;
  entryKey: string = '';
  text1: string = '';
  text2: string = '';
  ...
  constructor(data: Partial<MasterInsuranceUdcModel>) {
    super();
    this.update(data);
  }

  public update(data: Partial<MasterInsuranceUdcModel>): void {
