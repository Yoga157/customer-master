...
export const requestEmployee = async (): Promise<
...
export const requestEmployeeFixAll = async (): Promise<
  EmployeeModel | HttpErrorResponseModel
> => {
  const controllerName = `Employee`;
  const endpoint: string = environment.api.generic.replace(
...
export const requestEmp = async (): Promise<
  EmployeeModel | HttpErrorResponseModel
> => {
  const controllerName = `Employee`;
  const endpoint: string = environment.api.generic.replace(
...
export const requestEmployeeByRole = async (
...
export const requestEmployeeSubordinateDqAll = async (
  ...
  return EffectUtility.getToModel<EmployeeDqAllModel[]>(
    EmployeeDqAllModel,
    endpoint
  );
};
...
export const requestEmployeeByPOCType = async (
  pocType: string
): Promise<EmployeeModel | HttpErrorResponseModel> => {
...
export const requestDirectSubordinate = async (
  employeeID: number
): Promise<EmployeeModel[] | HttpErrorResponseModel> => {
...
export const requestEmployeeByName = async (
  employeeName: string,
  role?: string
): Promise<EmployeeModel | HttpErrorResponseModel> => {
...
export const reqEmployeeHierarcyDqSearch = async (
  operationtype: string,
  accountname: string,
  search: string,
...
export const requestEmployeeEngineerByName = async (
  employeeName: string
): Promise<EmployeeModel | HttpErrorResponseModel> => {
...
// employee by id
export const requestEmployeeById = async (
  employeeId: string
): Promise<EmployeeModel | HttpErrorResponseModel> => {
  const controllerName = `Employee/${employeeId}`;
  const endpoint: string = environment.api.generic.replace(
    ":controller",
    controllerName
  );
