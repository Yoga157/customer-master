...
export default class AWSBillingHPermission extends BaseModel {
  udcid:number = 0;
  entryKey: string = '';
  text1: string = '';
  text2: string = '';
  ...
  constructor(data: Partial<AWSBillingHPermission>) {
    super();
    this.update(data);
  }

  public update(data: Partial<AWSBillingHPermission>): void {
